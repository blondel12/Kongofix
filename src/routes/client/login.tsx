...
export const Route = createFileRoute("/client/login")({
  head: () => ({
    meta: [
      { title: "Connexion client — KongoFix" },
      { property: "og:title", content: "Connexion client — KongoFix" },
    ...
    <div className="min-h-[calc(100dvh-3.5rem)] flex items-center justify-center px-4 py-12">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Connectez-vous à votre espace client KongoFix
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter className="flex flex-col gap-2 text-center text-sm">
          <p className="text-muted-foreground">
            ...
            <Link to="/client/register" className="font-medium text-primary hover:underline">
              Créer un compte
            </Link>
          </p>
        </CardFooter>
